<template>
    ...
    @mouseout="buttonHovering=false">Toggle Editing</button>
    <button id="completedButton" @click="toggleCompleted"
    @mouseover="buttonHovering=true"
    @mouseout="buttonHovering=false">Toggle Completed</button>
...
#home{
    display: block;
    background: #FAEBD7
    url(//en.uesp.net/w/extensions/UespCustomCode/files/Parchment_bg.jpg)
    0 0 repeat;
}
input{
    display: block;
